    ...
    async def process_agency(agency):
        async with sem:
            try:
                ...
                # Calculate total word count from documents
...
async def fetch_recent_documents_all():
    ...
    params = {
        ...
        "order": "newest",
        "fields[]": ["title", "document_number", "publication_date", "type",
                     "pdf_url", "html_url", "agencies", "abstract"]
    }
...
async def recent_documents_page():
    ...
    for doc in docs:
        ...
        <tr>
            ...
            <td style="text-align: right;">{doc['word_count']:,} words</td>
...
async def index():
    ...
    total_words = sum(data["total_words"] for _, data in sorted_agencies)
    ...
    def generate_row(agency, data):
        ...
        total_words_agency = data["total_words"]
        ...
        <tr class="agency-row" onclick="toggleDocuments('docs-{data['agency_id']}')">
            ...
            <td style="text-align: right;">{total_words_agency:,}</td>
    ...
    <html>
    <head>
        <title>Federal Regulations-eCFRs Files Word Count</title>
        <style>
            body {{
    ...
    <body>
        <div class="container">
            <h1>📋 Federal Regulations-eCFRs Files Word Count</h1>
            ...
            <div class="metadata">
                ...
                <strong>Total Word Count:</strong> {total_words:,} words<br>
